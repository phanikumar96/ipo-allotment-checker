...
Retail / S-HNI / B-HNI **filters:** MUFG uses `PEMNDG` from the registrar; KFINTECH uses applied-share size (smallest = Retail, largest = B-HNI, in between = S-HNI). There is no Category column in the table.
